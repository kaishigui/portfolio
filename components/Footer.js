...
function Footer() {
  return (
    <footer className='bg-gray-900'>
      <main className='flex flex-col md:justify-evenly items-center bg-gray-900 text-white 
        md:h-20 md:flex-row max-w-8xl lg:mx-12 '>
        ...
        <div className='flex items-center space-x-5 px-20 py-2 '>
          <a href="https://www.linkedin.com/in/kashigui/">
            <button type="button" className='items-center p-2'>
              <svg 
                className='fill-current w-4 h-4 hover:text-purple-400 ease-in-out'
